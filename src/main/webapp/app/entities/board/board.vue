<template>
  <div>
    <h2 id="page-heading" data-cy="BoardHeading">
      <span id="board-heading">Boards</span>
      ...
      <table class="table table-striped" aria-describedby="boards">
        ...
        <tbody>
          <tr v-for="board in boards" :key="board.id" data-cy="entityTable">
            ...
            <td>{{ board.createdAt | formatDate }}</td>
            <td>{{ board.createdBy }}</td>
            <td>{{ board.modifiedAt | formatDate }}</td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="jhipsterGitApp.board.delete.question" data-cy="boardDeleteDialogHeading">Confirm delete operation</span></span
      >
