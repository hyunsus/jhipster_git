...
export default class Attach extends Vue {
  ...
  public retrieveAllAttachs(): void {
  ...
  public prepareRemove(instance: IAttach): void {
  ...
  public removeAttach(): void {
    this.attachService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Attach is deleted with identifier ' + this.removeId;
