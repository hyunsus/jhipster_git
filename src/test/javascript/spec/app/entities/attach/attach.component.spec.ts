...
import AttachComponent from '@/entities/attach/attach.vue';
import AttachClass from '@/entities/attach/attach.component';
...
describe('Component Tests', () => {
  describe('Attach Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<AttachClass>(AttachComponent, {
        store,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(attachServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(attachServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
