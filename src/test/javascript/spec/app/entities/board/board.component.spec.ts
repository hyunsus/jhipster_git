...
import BoardComponent from '@/entities/board/board.vue';
import BoardClass from '@/entities/board/board.component';
...
describe('Component Tests', () => {
  describe('Board Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<BoardClass>(BoardComponent, {
        store,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(boardServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(boardServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
